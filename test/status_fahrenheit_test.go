...
func TestStatusFahrenheint1(t *testing.T) {
	...
	r, err := status.StatusFahrenheit(212.00, f)
...
func TestStatusFahrenheint2(t *testing.T) {
	...
	want := fmt.Sprintf("%s there is %.2f %c from the %s\n", status.Msg_status, 92.00, f.GetSymbol(), status.Points[1])
	r, err := status.StatusFahrenheit(120.00, f)
...
func TestStatusFahrenheint3(t *testing.T) {
	...
	want := fmt.Sprintf("%s there is %.2f %c from the %s\n", status.Msg_status, -359.00, f.GetSymbol(), status.Points[2])
	r, err := status.StatusFahrenheit(-100.00, f)
...
func TestStatusFahrenheint4(t *testing.T) {
	...
	r, err := status.StatusFahrenheit(-459.00, f)
